...
const Categorias = () => {
    ...
    const allIds = datosFitrados.map(c => c.id);
            ...
            <section className="ca-page">
                ...
                <div className="ca-header">
                    ...
                    <div className="ca-header-content">
                        ...
                        <p className="ca-subtitle">Clasificación y organización de productos</p>
                    </div>
                ...
                <div className="ca-toolbar">
                    ...
                    <div className="ca-toolbar-right">
                        {!edicion ? (
                            <>
                                <button className="ca-btn ca-btn--add" onClick={abrirModalAgregar}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                ...
                                <button className="ca-btn ca-btn--del" onClick={abrirModalEliminar}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                        <path d="M4 7l16 0" />
                                        <path d="M10 11l0 6" />
                            ...
                            <>
                                ...
                                <button className="ca-btn ca-btn--save" onClick={GuardarEdicion}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                ...
                                <button className="ca-btn ca-btn--cancel" onClick={CancelarEdicion}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                        <path d="M18 6l-12 12" />
                                        <path d="M6 6l12 12" />
                ...
                <div className="ca-info-bar">
                    <span className="ca-info-item">
                        ...
                        <span className="ca-info-value">{datosFitrados.length}</span>
                    </span>
                        ...
                        <table className="ca-table">
                            ...
                            <tbody>
                                {datosFitrados.length > 0 ? (
                                    datosFitrados.map((Categoria, index) => (
                                        <tr
                                            key={Categoria.id}
                                        ...
                                        >
                                            <td className="ca-td ca-td--chk" onClick={(e) => e.stopPropagation()}>
                                                <input
                                                    type="checkbox"
                                                    className="ca-checkbox"
                                            ...
                                            <td className="ca-td">
                                                {categoriaEditando === Categoria.id ? (
                                                    ...
                                                    <span className="ca-nombre-txt">{Categoria.nombre}</span>
                                                )}
                                            </td>
                                        </tr>
                                    ))
                ...
                {showModalAgregar && (
                    <div className="ca-overlay" onClick={cerrarModalAgregar}>
                        <div className="ca-modal ca-modal--form" onClick={(e) => e.stopPropagation()}>
                            ...
                            <form className="ca-form" onSubmit={handleSubmit}>
                                ...
                                <div className="ca-modal-actions">
                                    ...
                                    <button type="button" className="ca-btn ca-btn--cancel" onClick={cerrarModalAgregar}>
                                        Cancelar
                                    </button>
                                </div>
                            </form>
                ...
                {showModalEliminar && (
                    <div className="ca-overlay" onClick={cerrarModalEliminar}>
                        <div className="ca-modal ca-modal--danger" onClick={(e) => e.stopPropagation()}>
                            <div className="ca-modal-corner ca-modal-corner--tl" />
                            <div className="ca-modal-corner ca-modal-corner--br" />
                            ...
                            <p className="ca-modal-body">
                                ¿Eliminar {seleccionados.length} categoría(s) seleccionada(s)? Esta acción no se puede deshacer.
                            </p>
                            <div className="ca-modal-actions">
                                <button className="ca-btn ca-btn--del" onClick={eliminarCategoriaSelec}>
                                    Confirmar
                                </button>
                                <button className="ca-btn ca-btn--cancel" onClick={cerrarModalEliminar}>
                                    Cancelar
                                </button>
                            </div>
                        </div>
